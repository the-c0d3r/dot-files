{
  ...
  outputs = { self, nixpkgs, home-manager, darwin, determinate, zen-browser, ... }@inputs:
    let
      # Get username from $USER environment variable
      # Requires --impure flag when building (e.g., nixos-rebuild switch --impure --flake .)
            ...
            packages = with pkgs; [
              (writeShellApplication {
                ...
                text = ''
                  ...
                  sudo darwin-rebuild switch --impure --flake ".#${darwinConfig}"
